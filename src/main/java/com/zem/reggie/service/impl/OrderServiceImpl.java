...
import com.zem.reggie.common.OrderStatusEnum;
import com.zem.reggie.common.BaseContext;
import com.zem.reggie.common.CustomException;
import com.zem.reggie.dto.OrdersDto;
import com.zem.reggie.entity.*;
import com.zem.reggie.entity.*;
import com.zem.reggie.mapper.OrderMapper;
import com.zem.reggie.service.*;
import com.zem.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void dispatchOrder(Long orderId) {
        ...
        updateWrapper.eq(Orders::getId, orderId)
                .set(Orders::getStatus, OrderStatusEnum.DISPATCHING.getCode());
    ...
    public void completeOrder(Long orderId) {
        LambdaUpdateWrapper<Orders> updateWrapper = new LambdaUpdateWrapper<>();
        updateWrapper.eq(Orders::getId, orderId)
                .set(Orders::getStatus, OrderStatusEnum.COMPLETED.getCode());
        this.update(updateWrapper);
    }
